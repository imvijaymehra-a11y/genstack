...
export default function ImageToolForm({ toolName, toolSlug, onGenerate, isGenerating }: ImageToolFormProps) {
  ...
  const getPlaceholder = () => {
    const placeholders: Record<string, string> = {
      ...
      'image-enhancer': 'Describe what kind of enhancement you want (e.g., "increase resolution", "improve colors", "reduce noise")...',
      ...
      >
        {isGenerating ? (
          ...
          <>
            ...
            {isImageTool ? 'Process Image' : 'Generate Content'}
          </>
        )}
      </button>
          ...
          <ul className="text-sm text-blue-800 dark:text-blue-200 space-y-1">
            ...
            {toolSlug === 'image-enhancer' && (
              <>
                ...
                <li>• Specify the type of enhancement needed in the text field</li>
                <li>• Multiple enhancements may be processed in sequence</li>
              </>
            )}
